import { IconArrowLeft, IconFileText, IconGavel, IconScale, IconShield } from '@tabler/icons-react'
import type { Metadata } from 'next'
import Image from 'next/image'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Nuestra Bandera - San Benito',
  description:
    'Conocé la historia, descripción y el uso protocolar de la Bandera de San Benito, un símbolo de nuestra identidad y autonomía municipal.',
}
...
export default function BanderaPage() {
  return (
    <main className="container mx-auto space-y-4 p-4 sm:space-y-10 sm:p-6">
      <Link
        href="/nuestra-ciudad"
        className="btn btn-link mb-2 pl-0 text-primary hover:no-underline"
      >
      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2">
        <div className="bg-base-100 rounded-lg p-5 shadow-md sm:p-6">
          <div className="flex items-center gap-3 mb-3 sm:mb-4">
            <IconFileText className="text-primary" size={30} stroke={1.5} />
            <h2 className="text-2xl font-semibold sm:text-3xl">Descripción</h2>
          </div>
        ...
        <div className="bg-base-100 flex flex-col items-center justify-center rounded-lg p-5 shadow-md sm:p-6">
          <div className="flex items-center gap-3 mb-3 sm:mb-4">
            <IconShield className="text-primary" size={30} stroke={1.5} />
            <h2 className="text-2xl font-semibold sm:text-3xl">Escudo Municipal</h2>
          </div>
          <Image
        ...
        <div className="bg-base-100 col-span-1 rounded-lg p-5 shadow-md sm:p-6 md:col-span-2">
          <div className="flex items-center gap-3 mb-3 sm:mb-4">
            <IconGavel className="text-primary" size={30} stroke={1.5} />
            <h2 className="text-2xl font-semibold sm:text-3xl">Uso Protocolar</h2>
          </div>
          <p className="text-base leading-relaxed sm:text-lg">
      ...
      <section className="bg-base-100 rounded-lg p-5 shadow-md sm:p-6">
        <div className="flex items-center justify-center gap-3 mb-3 sm:mb-4">
          <IconScale className="text-primary" size={30} stroke={1.5} />
          <h2 className="text-2xl font-semibold sm:text-3xl">Marco Legal</h2>
        </div>
