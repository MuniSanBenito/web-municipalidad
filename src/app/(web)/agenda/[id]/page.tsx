  ...
  try {
    ...
    return (
      <main className="bg-base-100 min-h-screen">
        {/* Banner principal */}
        <div className="relative h-64 max-h-96 w-full overflow-hidden shadow-md md:rounded-b-3xl">
          <img
            src={
              evento.imagen?.url ||
        ...
        <section className="container mx-auto max-w-3xl px-4 py-8 sm:px-6">
          <div className="mb-8 flex flex-col gap-4 md:flex-row">
            {/* Fecha */}
            <div className="bg-primary/10 text-primary flex items-center gap-2 rounded-lg px-4 py-2 font-medium shadow">
              <svg
            ...
            {evento.ubicacion && evento.ubicacion.nombre && (
              <div className="bg-secondary/10 text-secondary flex items-center gap-2 rounded-lg px-4 py-2 font-medium shadow">
                <svg
          ...
          {/* Descripción */}
          <div className="bg-base-200 mb-8 rounded-xl p-6 shadow-lg">
