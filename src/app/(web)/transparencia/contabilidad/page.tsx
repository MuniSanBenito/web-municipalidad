...
import { IconFileText, IconGavel, IconScale } from '@tabler/icons-react'
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12 text-center">
        <p className="text-lg text-gray-600">
          En esta sección encontrará información relevante sobre la gestión financiera del municipio,
          incluyendo licitaciones, concursos y balances mensuales.
        </p>
      </div>
      ...
      <div className="mt-12">
        <h3 className="text-2xl font-bold mb-6">Documentos Recientes</h3>
