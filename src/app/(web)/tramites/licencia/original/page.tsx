export default function LicenciaOriginalPage() {
  return (
      ...
      <section className="hero bg-base-200 rounded-lg p-4 text-center shadow-lg md:p-10">
        <div className="hero-content">
          <div className="mx-auto max-w-3xl">
            ...
            <h2 className="mt-4 text-2xl font-semibold md:text-3xl">Original</h2>
          </div>
        </div>
      </section>
      ...
      <section className="mt-8 space-y-6">
        <div className="bg-base-100 rounded-lg p-6 shadow-md">
          ...
          <ul className="list-disc space-y-4 pl-6">
            <li>Constancia del grupo Sanguíneo.</li>
            ...
            <li>Es requisito obligatorio saber leer para solicitar clases A y B.</li>
            <li>
              Se deberá abonar en el momento de hacer el trámite el valor de la Tasa Municipal, la cual es emitida por el área de Rentas el mismo día del turno.
            </li>
            <li>
            ...
            <li>
              ...
              <ul className="list-disc mt-2 pl-6 space-y-2">
                ...
                <li>
                  Para jóvenes de entre 16 y 21 años inclusive, que tramiten por primera vez la Licencia Nacional para conducir automóvil y/o motocicleta.
                  Cuando sacás por primera vez la Licencia Nacional de Conducir, o cuando la misma vuelve a un trámite original deberá realizar el siguiente curso:{' '}
                  <a 
