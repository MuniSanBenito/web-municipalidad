        ...
        <div className="bg-base-100 rounded-lg p-6 shadow-md">
          <div className="prose max-w-none">
            <p className="text-lg">
              ...
              erradicar la violencia de género en nuestra ciudad. Tenemos como objetivo de
              visibilizar las violencias vividas por las mujeres en nuestra sociedad para así
              generar herramientas para acompañar, asesorar, y contener a todas las mujeres que así
              lo necesiten. Nuestro equipo de trabajo esta conformado por:
            </p>

            <div className="card bg-base-200 mt-4 shadow-md">
            ...
            <div className="bg-base-200 mt-6 flex items-center justify-between rounded-lg p-4">
              <div>
            ...
            <div className="mt-8">
              <h3 className="mb-3 text-center text-xl font-semibold">Formulario de Contacto</h3>
