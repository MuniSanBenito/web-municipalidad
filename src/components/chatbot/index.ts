...
// Knowledge Base
export {
    ACTIVIDADES_DEPORTIVAS, CAV,
    CONTACTO_GENERAL, HABILITACIONES,
    LICENCIA_CONDUCIR,
    OBRAS_PRIVADAS,
    RENTAS,
    SERVICIOS_COMPLETOS, buscarServicioPorKeyword, formatearServicio
...
export type {
    ...
    AIStats,
    // ActionProvider
    ActionProviderProps, CachedResponse,
    // Mensajes
    ChatMessage,
    ChatMessageOptions,
    ChatState,
    // Config
    ChatbotConfig,
    ChatbotStyles, ContextualSuggestion,
    // Historial
    ConversationEntry,
    ConversationHistory,
