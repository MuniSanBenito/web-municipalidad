      ...
      <div className="drawer-content flex flex-col">
        ...
        >
          <div className="container mx-auto flex h-full items-center justify-between px-6">
            ...
            <div className="hidden md:justify-start lg:flex lg:flex-1">
...
//       <div
//         className={twJoin(
//           'bg-accent fixed left-0 z-50 h-full w-4/7 transition-transform duration-300',
...
//   <nav
//     className={twJoin(
//       'navbar bg-primary fixed top-0 left-0 z-50 w-full transition-all duration-300 shadow-md',
//       isScrolled ? 'h-16' : 'h-28'
//     )}
//   >
//     <div className='container mx-auto flex h-full items-center justify-between px-6'>
...
//     <div
//       className={twJoin(
//         'fixed left-0 z-40 w-4/5 h-full bg-accent bg-opacity-90 backdrop-blur-md transition-transform duration-300 md:hidden',
//         isScrolled ? 'top-16' : 'top-28',
//         isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
//       )}
//     >
...
//           {NAV_LINKS.map((link) => (
//             <li key={link.href}>
//               <Link href={link.href} className='block py-3 hover:text-black' onClick={() => setIsMobileMenuOpen(false)}>
//                 {link.label}
//               </Link>
//             </li>
//           ))}
