...
async function loadTemplate(data, isDefaultTemplate) {
  $(document).ready( async function() {
    ...
    if (loadCharts) {
      ...
      $.getScript("/servicios/ide/src/js/components/charts/charts.js");
      $('head').append('<link rel="stylesheet" type="text/css" href="/servicios/ide/src/js/components/charts/charts.css">');
    }
