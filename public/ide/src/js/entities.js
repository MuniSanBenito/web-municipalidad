...
class GestorMenu {
                ...
                $(".collapse").on('show.bs.collapse', function (e) {
                    if ($(this).is(e.target)) {
                        ...
                        if ($('#' + showingId + ' > div').html() == '') {
                            $('#' + showingId + ' > div').html('<div class="loading"><img src="/servicios/ide/src/styles/images/loading.svg" style="width:35px"></div>');
                        }
    ...
    showWMSLayerCombobox(itemSeccion) {
        ...
        //Loader gif
        $('#wms-combo-list').html('<div class="loading"><img src="/servicios/ide/src/styles/images/loading.svg"></div>');
