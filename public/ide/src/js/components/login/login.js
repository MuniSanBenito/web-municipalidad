const login = {
    ...
    load: async function () {
        await login._append("/servicios/ide/src/js/components/login/navbtn.html", "html", "navbar");
        await login._append("/servicios/ide/src/js/components/login/form.html", "html", "body");
        login._listeners();
    },
